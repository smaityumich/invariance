...
class InvarianceNNGraph(keras.Model, keras.layers.Layer):
    ...
    def __init__(self):
        ...
        self.weight = {'weight1': self.add_weight(shape=(8, 10), initializer=initializer, trainable=True), 
                        'weight2': self.add_weight(shape=(10, 1), initializer=initializer, trainable=True)}
